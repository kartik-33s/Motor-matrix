          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-gray-900/90 border border-gray-800 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 rounded-xl pl-11 pr-4 py-2.5 text-sm text-white placeholder-gray-500 outline-none transition-all"
              />
            </div>
          </div>
